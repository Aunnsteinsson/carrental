class Employee(object):
    ...
    def change_address(self, new_address):
        """Tekur inn heimilsifang og breytir heimilisfangi stafsmanns
         í það heimilisfang"""
        self.__address = new_address

    def change_password(self, new_password):
        """Tekur inn lykilorð og breytir lykilorði starfsmanns í það
         lykilorð"""
        self.__password = new_password

    def change_phone_number(self, new_phone_number):
        """Tekur inn símanúmer og breytir símanúmeri starfsmanns í það
         símanúmer"""
